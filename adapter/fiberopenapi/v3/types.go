...
type Router interface {
	...
	Get(path string, handler fiber.Handler, handlers ...any) Route
	// Head registers a HEAD route.
	Head(path string, handler fiber.Handler, handlers ...any) Route
	// Post registers a POST route.
	Post(path string, handler fiber.Handler, handlers ...any) Route
	// Put registers a PUT route.
	Put(path string, handler fiber.Handler, handlers ...any) Route
	// Patch registers a PATCH route.
	Patch(path string, handler fiber.Handler, handlers ...any) Route
	// Delete registers a DELETE route.
	Delete(path string, handler fiber.Handler, handlers ...any) Route
	// Connect registers a CONNECT route.
	Connect(path string, handler fiber.Handler, handlers ...any) Route
	// Options registers an OPTIONS route.
	Options(path string, handler fiber.Handler, handlers ...any) Route
	// Trace registers a TRACE route.
	Trace(path string, handler fiber.Handler, handlers ...any) Route

	// Add registers a route with the specified method and path.
	Add(methods []string, path string, handler fiber.Handler, handlers ...any) Route
