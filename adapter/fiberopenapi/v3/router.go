...
import (
	...
	"github.com/oaswrap/spec/adapter/fiberopenapi/v3/internal/constant"
...
func (r *router) Get(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodGet}, path, handler, handlers...)
}

func (r *router) Head(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodHead}, path, handler, handlers...)
}

func (r *router) Post(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodPost}, path, handler, handlers...)
}

func (r *router) Put(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodPut}, path, handler, handlers...)
}

func (r *router) Patch(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodPatch}, path, handler, handlers...)
}

func (r *router) Delete(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodDelete}, path, handler, handlers...)
}

func (r *router) Connect(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodConnect}, path, handler, handlers...)
}

func (r *router) Options(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodOptions}, path, handler, handlers...)
}

func (r *router) Trace(path string, handler fiber.Handler, handlers ...any) Route {
	return r.Add([]string{fiber.MethodTrace}, path, handler, handlers...)
}

func (r *router) Add(methods []string, path string, handler fiber.Handler, handlers ...any) Route {
	// If handler is nil, provide a default handler that returns 501 Not Implemented
	if handler == nil {
	...
	fr := r.fiberRouter.Add(methods, path, handler, handlers...)
	route := &route{fr: fr}
	...
	for _, m := range methods {
		...
		route.sr = r.specRouter.Add(m, path)
	}
